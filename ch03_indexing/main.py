...
for alphabat in str_example:        # enhanced-for 생각하면 편함
    print(alphabat, end=' ')
...
print(str_example[2:8:2]) #0번지부터 순서대로 3번 인덱스 미만까지만 출력한다는 의미
...
네 자리 숫자를 입력하시오 >> 2025
맨 마지막 숫자는 5입니다.
맨 마지막 수는 5이며, 홀수 입니다. -> 조건문 써야합니다.
'''

number = input('네 자리 숫자를 입력하시오 >>  ')
...
if last_number % 2 == 0:
    ...
    result = '홀'
print(f'마자막 숫자는 {last_number}입니다')
print(f'마자막 숫자는 {last_number}입니다 {result} 입니다')
