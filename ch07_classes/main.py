...
1. 클래스의 기본 구성
    ...
    클래스를 구성하는 속성은 두 가지로 구분됩니다.
        1) 클래스 변수 : 클래스를 기반으로 생성된 모든 인스턴스들이 공유하는 변수(Java에서는 얘를 static 변수라고 했습니다)
    ...
    그리고 Java에서 this 썼는데(아직 생성되지 않은 객체명을 도입할 수 없으니 사용하는 키워드), python 에서는 self 씁니다. 예시 보여드리겠습니다.
